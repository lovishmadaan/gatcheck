...
for dataset_name in datasets_name:
    ...
    with open('results/{}/{}_{}_{}_layer{}_approximate{}_h{}_ina{}_outa{}_act{}.txt'.format(args.dataset,args.task,args.model,dataset_name,args.layer_num,args.approximate, args.hidden_dim, args.attention_heads, args.out_attention_heads, args.activation), 'w') as f:
